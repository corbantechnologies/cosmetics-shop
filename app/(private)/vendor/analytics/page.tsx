...
const KPICard = ({
  ...
  <div className="bg-white rounded-2xl border border-secondary/30 p-5 flex items-start justify-between hover:shadow-md hover:border-primary/30 transition-all duration-200 group">
...
const SourceBadge = ({
  ...
  return (
    <div className="bg-white rounded-2xl border border-secondary/30 p-5">
...
const SalesChart = ({
  ...
  if (isLoading) {
    return (
      <div className="h-72 flex items-center justify-center bg-secondary/10 rounded-2xl border border-secondary/30">
  ...
  if (!data || data.length === 0) {
    return (
      <div className="h-72 flex flex-col items-center justify-center bg-secondary/10 rounded-2xl border border-dashed border-secondary/30 gap-3">
        <div className="w-12 h-12 bg-white rounded-2xl border border-secondary/30 flex items-center justify-center">
  ...
  return (
    <div className="bg-white rounded-2xl border border-secondary/30 p-5 md:p-6">
        ...
        {data.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              {/* X-Axis Label */}
              <div className="mt-2 text-[10px] text-muted-foreground font-mono truncate w-full text-center hidden md:block">
...
export default function AnalyticsPage() {
  ...
  return (
    <div className="min-h-screen bg-secondary/10 pb-12">
      <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-12">
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <select
              ...
              className="px-3 py-2 border border-secondary/30 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all bg-white min-w-[100px]"
            >
            ...
            <select
              ...
              className="px-3 py-2 border border-secondary/30 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all bg-white min-w-[140px]"
            >
            ...
            {dateRange === "custom" && (
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="px-3 py-2 border border-secondary/30 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all bg-white"
                />
          ...
          {kpiLoading ? (
            Array(6)
              ...
              .map((_, i) => (
                <div
                  key={i}
                  className="h-32 bg-white rounded-2xl border border-secondary/30 animate-pulse"
                />
              ))
          ) : kpi ? (
            <>
            ...
            <div className="col-span-full py-16 text-center">
              <p className="text-sm font-semibold text-foreground">No KPI data available</p>
              <p className="text-xs text-muted-foreground mt-1">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-secondary/30 p-5">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center text-sm">
                  <span className="text-foreground/70">Online Revenue</span>
                  <span className="font-medium text-foreground">
                    {kpi ? formatCurrency(kpi.online_revenue, currency) : "—"}
                  </span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-foreground/70">POS Revenue</span>
                ...
                <div className="flex justify-between items-center text-sm">
                  <span className="text-foreground/70">Busiest Day</span>
                  <span className="font-medium text-foreground">
