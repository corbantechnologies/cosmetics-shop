...
export default function PickupStationDetailPage() {
  ...
  if (isLoading) return <div className="p-20 text-center text-muted-foreground">Loading station details...</div>;
      ...
      <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 space-y-8">
            <div className="bg-white border border-secondary/30 rounded-3xl p-8 shadow-sm">
              <div className="flex justify-between items-start mb-8">
                <div>
                  ...
                  <h1 className="text-3xl font-serif font-bold text-foreground tracking-tight">{station.name}</h1>
                  <p className="text-muted-foreground text-sm mt-1 font-mono">{station.station_code}</p>
                </div>
                {vendor?.is_superuser && (
                  <button 
            ...
            <div className="bg-white border border-secondary/30 rounded-3xl p-8 shadow-sm">
              <h3 className="text-lg font-serif font-bold text-foreground mb-4">Location & Access</h3>
              ...
              {station.map_link && (
                <a 
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-xl text-sm font-bold hover:bg-primary/90 transition-all shadow-md shadow-primary/20"
                >
          ...
          <div className="w-full lg:w-80 space-y-6">
            <div className="bg-white border border-secondary/30 rounded-3xl p-6 shadow-sm">
              <h4 className="text-sm font-bold text-foreground mb-4">Status</h4>
            ...
            <div className="bg-[#1D1D1F] p-6 rounded-3xl shadow-xl">
              ...
              <p className="text-white text-2xl font-serif font-bold mb-1">Coming Soon</p>
