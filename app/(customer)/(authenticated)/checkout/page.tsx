        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <section className="bg-background p-6 rounded-sm shadow-sm">
              ...
              <div className="space-y-4">
                {cart.items.map((item) => (
                  <div key={item.reference} className="flex gap-4 py-4 border-b border-secondary/10 last:border-0">
                    <div className="relative w-16 h-16 bg-secondary/10 rounded-xl overflow-hidden flex-shrink-0 border border-secondary/20">
                      <Image
          ...
          <div className="lg:col-span-1">
            <div className="bg-background p-6 rounded-sm shadow sticky top-24">
              ...
              <div className="flex justify-between text-lg font-serif font-bold text-foreground mb-8">
                <span>Total</span>
