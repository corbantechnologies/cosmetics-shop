                ...
                <div className="absolute inset-0 flex flex-col justify-between p-12 z-20">
                    ...
                    <div className="text-white">
                        <p className="text-3xl font-serif leading-tight mb-4">
                            "Beauty is not just about how you look, <br />but how you feel."
                        </p>
                        <p className="opacity-80 font-light">
                            - The Clate Philosophy
                        </p>
                    </div>
                </div>
                    ...
                    <form onSubmit={formik.handleSubmit} className="space-y-6">
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <label htmlFor="email" className="text-sm font-medium text-foreground/80 cursor-pointer">
                                    Email Address
                                </label>
                                <input
                                    id="email"
