...
export default function UpdateShippingZone({
  ...
  if (isLoading) return <div className="p-12 text-center text-sm text-muted-foreground">Loading zone details...</div>;
    ...
    <form onSubmit={formik.handleSubmit} className="space-y-6 w-full max-w-lg">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="md:col-span-2">
          ...
          <input
            ...
            className="w-full px-4 py-2 bg-white border border-secondary/30 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
          />
        </div>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-4 py-2 bg-white border border-secondary/30 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none"
        />
      </div>

      <div className="space-y-4">
        <div>
          <label htmlFor="delivery_cost" className="block text-sm font-medium text-foreground mb-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-2 bg-white border border-secondary/30 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
            />
          </div>
        </div>
        <div>
          <label htmlFor="estimated_delivery_days" className="block text-sm font-medium text-foreground mb-1">
            ETA (Days)
          </label>
          <input
      ...
      <div className="flex items-center gap-3 p-4 bg-secondary/10 rounded-2xl border border-secondary/30">
        <input
          ...
          className="h-5 w-5 rounded-lg border-secondary/30 text-primary focus:ring-primary/20 transition-all"
        />
        <label htmlFor="is_active" className="text-sm font-semibold text-foreground cursor-pointer">
          Zone is Active
          <span className="block text-[10px] text-muted-foreground font-normal uppercase tracking-wider mt-0.5">
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full py-3 px-4 bg-primary text-white font-bold rounded-xl hover:bg-primary/90 active:bg-[#005BB5] transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-primary/20"
      >
